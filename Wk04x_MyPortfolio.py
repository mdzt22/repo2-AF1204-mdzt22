...
def _(count, filtered_portfolio, mo, pd, px):
    ...
    fig_travel = px.scatter_geo(
        ...
        title="Places I'd Love to Visit / Global Interests",
...
def _(cap_slider, chart_element, fig_travel, mo, sector_dropdown):
    ...
    tab_cv = mo.md(
        """
        ### Accounting and Finance student | Learning Data Science

        **Summary:**
        - Motivated student developing skills in finance, technology, and data analysis.
        - Interested in learning Python, solving problems, and building practical projects.
    ...
    tab_data_content = mo.vstack([
        mo.md("## 📊 Credit Risk Dashboard: Debt vs Financial Health"),
        # create an informational callout box with the instruction text inside
        mo.callout(mo.md("This dashboard explore how company borrowing costs relate to financial health using Altman Z-Score and sector analysis."), kind="info"),
    ...
    tab_personal = mo.vstack([
        mo.md("## 🌍 Personal Interests & Growth"),
        mo.md("Outside academics, I enjoy travel, fitness, football, and learning about technology and global markets."),
